  ...
  return (
    <main className="min-h-screen bg-[#f4f1ea]">
      ...
      <section className="relative overflow-hidden bg-[#0a1a10] px-6 py-24 text-white sm:py-32 lg:px-20">
        ...
        <div className="relative mx-auto max-w-4xl">
          <div className="flex items-center gap-3 mb-6">
            ...
            <span className="text-[11px] font-semibold uppercase tracking-[0.32em] text-[#c9962a]">Real Children · Real Change</span>
          </div>
          ...
          <p className="mt-8 max-w-2xl text-lg leading-8 text-white/65">
            These are not statistics. These are children with names, voices, dreams — and futures that changed because someone chose to care.
          </p>
        </div>
      </section>
            ...
            <div className="grid overflow-hidden lg:grid-cols-2">
              <div className="relative min-h-[420px] bg-[#0a1a10]">
                ...
                <div className="absolute bottom-8 left-8">
                  <span className="inline-block bg-[#c9962a] px-3 py-1.5 text-[10px] font-bold uppercase tracking-[0.2em] text-[#0a1a10]">Featured Story</span>
                </div>
              </div>
              <div className="bg-[#0a1a10] p-10 lg:p-14 flex flex-col justify-center">
                <span className="text-[10px] font-bold uppercase tracking-[0.28em] text-[#c9962a]">Education · Bo, Sierra Leone</span>
                <h2 className="mt-4 font-heading text-3xl font-semibold leading-tight text-white lg:text-4xl">
                  Aminata — Age 10<br /><em className="italic text-[#e8b84b]">"I want to become a teacher one day."</em>
                </h2>
        ...
        <div className="mx-auto max-w-6xl">
          <Reveal direction="up">
            <div className="flex items-center gap-4 mb-12">
              <div className="h-px w-10 bg-[#c9962a]" />
              <span className="text-[11px] font-semibold uppercase tracking-[0.32em] text-[#c9962a]">More Stories</span>
            </div>
          </Reveal>
                ...
                <article className="group flex flex-col overflow-hidden bg-white shadow-[0_2px_20px_rgba(0,0,0,0.06)] transition-all duration-500 hover:-translate-y-1 hover:shadow-[0_16px_48px_rgba(0,0,0,0.1)]">
                  <div className="relative h-56 overflow-hidden bg-[#d4d8da]">
                    ...
                    <div className="absolute bottom-4 left-4">
                      <span className="inline-block px-2.5 py-1 text-[9px] font-bold uppercase tracking-[0.2em]" style={{ background: s.color, color: s.color === "#c9962a" ? "#0a1a10" : "white" }}>{s.program}</span>
                    </div>
                  </div>
                  <div className="flex flex-1 flex-col p-7">
                    <div className="h-[2px] w-8 bg-[#c9962a] mb-4 transition-all duration-500 group-hover:w-14" />
                    <h3 className="font-heading text-xl font-semibold text-[#1a2e1f]">{s.name}, Age {s.age} · {s.location}</h3>
                    <p className="mt-2 font-heading text-base italic text-[#c9962a]">"{s.quote}"</p>
                    <p className="mt-4 flex-1 text-[14px] leading-7 text-[#626a67]">{s.story}</p>
                  </div>
                </article>
              </Reveal>
            ))}
      ...
      <section className="bg-[#214c34] px-6 py-20 text-center lg:px-20">
        <Reveal direction="up">
          <span className="text-[11px] font-semibold uppercase tracking-[0.32em] text-[#c9962a]">Be Part of the Story</span>
