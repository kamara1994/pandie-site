...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${base}/talents/gallery`, lastModified: now, changeFrequency: "weekly", priority: 0.85 },
    { url: `${base}/sponsor`, lastModified: now, changeFrequency: "monthly", priority: 0.7 },
    { url: `${base}/child-safeguarding`, lastModified: now, changeFrequency: "yearly", priority: 0.4 },
