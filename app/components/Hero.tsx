        ...
        <div className="max-w-3xl">
          ...
          <div className="mt-8 flex flex-col gap-3 transition-all duration-700 motion-reduce:transition-none sm:mt-10 sm:flex-row sm:flex-wrap sm:gap-4"
            ...
            <Link href="/donate"
              ...
              <span className="relative z-10 flex items-center gap-3"><svg className="h-3.5 w-3.5 shrink-0" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"/></svg>{t.hero.cta1} <span className="text-base leading-none">→</span></span>
