...
const items = [
  "Safe spaces and emergency support",
  "Child welfare advocacy",
  "Essential supplies and clothing",
  "Consistent adult presence and mentorship",
      ...
      <section className="relative overflow-hidden bg-[#0a1a10] px-6 py-24 text-white lg:px-20">
        ...
        <div className="relative mx-auto max-w-5xl">
          ...
          >
            ...
            <span className="text-[11px] font-semibold uppercase tracking-[0.32em] text-[#c9962a]">Program 04</span>
          </div>
          <h1
          ...
          >
            Child<br /><em className="italic text-[#e8b84b]">Protection</em>
          </h1>
          <p
          ...
          >
            A child cannot learn if they do not feel safe. Protection is the foundation beneath everything else.
          </p>
          <div
          ...
          <Reveal direction="left">
            <div>
              ...
              <h2 className="mt-4 font-heading text-[clamp(32px,4vw,52px)] font-semibold leading-tight text-[#1a2e1f]">
                Some Children Have<br /><em className="italic text-[#214c34]">No One in Their Corner</em>
              </h2>
              <p className="mt-6 text-[16px] leading-8 text-[#626a67]">
                Across Sierra Leone, vulnerable children face neglect, extreme poverty, and environments where no adult is truly looking out for them. Without protection, a child&apos;s potential is extinguished before it ever has a chance to shine.
              </p>
              <div className="mt-10">
            ...
            <Reveal direction="right" delay={100}>
              <div className="bg-[#0a1a10] p-8 text-white">
                ...
                <p className="mt-4 text-[16px] leading-8 text-white/70">
                  Protection is the foundation beneath everything else. A child cannot learn if they do not feel safe. A child cannot grow if no one is protecting their dignity. When we protect children, we protect their entire future.
                </p>
              </div>
            </Reveal>
            <Reveal direction="right" delay={200}>
              <div className="bg-white p-8 shadow-[0_4px_24px_rgba(0,0,0,0.07)]">
                ...
                <h3 className="mt-3 font-heading text-2xl font-semibold text-[#1a2e1f] leading-tight">
                  He Was Alone.<br /><em className="italic text-[#214c34]">Now He Knows Someone Cares.</em>
                </h3>
                <p className="mt-4 text-[15px] leading-7 text-[#626a67]">
                  At 8 years old, Ishmael had no adult looking out for him. Living in a precarious situation with little food or safety, he had begun to believe that no one in the world cared. Through our protection program, he received support, stability, and most importantly — someone who showed up for him consistently.
                </p>
              </div>
            </Reveal>
            <Reveal direction="right" delay={300}>
              <div className="border-l-2 border-[#c9962a] pl-6 py-2">
                <p className="font-heading text-xl font-light italic text-[#1a2e1f]/70">
                  &ldquo;Every vulnerable child deserves to be seen, heard, and protected.&rdquo;
                </p>
      ...
      <section className="bg-[#c9962a] px-6 py-20 text-center lg:px-20">
        <Reveal direction="up">
          ...
          <h2 className="mt-4 font-heading text-[clamp(36px,4vw,58px)] font-semibold text-[#0a1a10]">
            Stand with a child<br />who has no one else
          </h2>
          <p className="mx-auto mt-6 max-w-lg text-lg text-[#0a1a10]/70">
            Your support gives vulnerable children safety, dignity, and the protection every child deserves as a human being.
          </p>
