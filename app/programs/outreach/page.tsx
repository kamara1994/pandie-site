...
const items = [
  ...
  "Partnership with local schools and leaders",
  "Family support and guidance sessions",
  "Volunteer coordination and training",
  "Awareness campaigns for child welfare",
      ...
      <section className="relative overflow-hidden bg-[#0a1a10] px-6 py-24 text-white lg:px-20">
        ...
        <div className="relative mx-auto max-w-5xl">
          ...
          >
            ...
            <span className="text-[11px] font-semibold uppercase tracking-[0.32em] text-[#c9962a]">Program 06</span>
          </div>
          <h1
          ...
          >
            Community<br /><em className="italic text-[#e8b84b]">Outreach</em>
          </h1>
          <p
          ...
          >
            A child is only as strong as the community around them. We strengthen both — so the impact lasts generations.
          </p>
          <div
          ...
          <Reveal direction="left">
            <div>
              ...
              <h2 className="mt-4 font-heading text-[clamp(32px,4vw,52px)] font-semibold leading-tight text-[#1a2e1f]">
                Change That Lasts<br /><em className="italic text-[#214c34]">Beyond Our Programs</em>
              </h2>
              <p className="mt-6 text-[16px] leading-8 text-[#626a67]">
                We don&apos;t just deliver services — we build relationships. By working hand-in-hand with families, school leaders, and local community figures, we create systems of support that continue to protect children long after our immediate programs end.
              </p>
              <div className="mt-10">
            ...
            <Reveal direction="right" delay={100}>
              <div className="bg-[#0a1a10] p-8 text-white">
                ...
                <p className="mt-4 text-[16px] leading-8 text-white/70">
                  When we strengthen families and local systems, we create a protective network that keeps children safe long after our immediate programs have ended. That is how we create change that lasts generations — not just relief, but transformation.
                </p>
              </div>
            </Reveal>
            <Reveal direction="right" delay={200}>
              <div className="bg-white p-8 shadow-[0_4px_24px_rgba(0,0,0,0.07)]">
                ...
                <h3 className="mt-3 font-heading text-2xl font-semibold text-[#1a2e1f] leading-tight">
                  When One Child Is Helped,<br /><em className="italic text-[#214c34]">A Village Feels It</em>
                </h3>
                <p className="mt-4 text-[15px] leading-7 text-[#626a67]">
                  In one community in Sierra Leone, our outreach team worked with local school leaders to identify children at risk of dropping out. By bringing families together and coordinating support, 12 children who were about to leave school remained enrolled — and the whole community celebrated.
                </p>
              </div>
            </Reveal>
            <Reveal direction="right" delay={300}>
              <div className="border-l-2 border-[#c9962a] pl-6 py-2">
                <p className="font-heading text-xl font-light italic text-[#1a2e1f]/70">
                  &ldquo;We don&apos;t just help children. We build the communities that protect them.&rdquo;
                </p>
      ...
      <section className="bg-[#c9962a] px-6 py-20 text-center lg:px-20">
        <Reveal direction="up">
          ...
          <h2 className="mt-4 font-heading text-[clamp(36px,4vw,58px)] font-semibold text-[#0a1a10]">
            Help us reach<br />more communities
          </h2>
          <p className="mx-auto mt-6 max-w-lg text-lg text-[#0a1a10]/70">
            Your donation and partnership helps us extend our reach to more families and communities across Sierra Leone.
          </p>
          <div className="mt-10 flex flex-wrap justify-center gap-4">
            ...
            <Link href="/contact" className="border-2 border-[#0a1a10] px-10 py-4 text-[11px] font-bold uppercase tracking-[0.2em] text-[#0a1a10] transition hover:bg-[#0a1a10]/10">
              Partner With Us
            </Link>
          </div>
        </Reveal>
