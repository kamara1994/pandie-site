          ...
          <div className="space-y-6">
            ...
            <div className="rounded-2xl bg-white p-8 shadow-[0_10px_30px_rgba(0,0,0,0.05)]">
              ...
              <div className="mt-6 space-y-5">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="text-xs font-bold uppercase tracking-[0.16em] text-[#d4a017]">Email</p>
                    <a href="mailto:info@pandiefoundation.org" className="mt-1 text-[15px] text-[#214c34] hover:text-[#d4a017] transition">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="text-xs font-bold uppercase tracking-[0.16em] text-[#d4a017]">Phone</p>
                    <a href="tel:+13072570001" className="mt-1 text-[15px] text-[#214c34] hover:text-[#d4a017] transition">
                      +1 (307) 257-0001
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="text-xs font-bold uppercase tracking-[0.16em] text-[#d4a017]">Address</p>
                    <p className="mt-1 text-[15px] text-[#214c34]">
                      Pandie Foundation<br />
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="text-xs font-bold uppercase tracking-[0.16em] text-[#d4a017]">Office Hours</p>
                    <p className="mt-1 text-[15px] text-[#214c34]">
            ...
            <div className="rounded-2xl bg-white p-8 shadow-[0_10px_30px_rgba(0,0,0,0.05)]">
              ...
              <div className="mt-5 flex flex-wrap gap-3">
                <a href="#" className="flex items-center gap-2 rounded-xl border border-[#e7dfd0] bg-[#fcfaf6] px-4 py-3 text-sm font-semibold text-[#214c34] transition hover:bg-[#214c34] hover:text-white">
            ...
            {success ? (
              <div className="mt-8 rounded-2xl bg-[#214c34] p-8 text-center text-white">
                <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-white/10">
                  <svg className="h-8 w-8 text-[#f0c857]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              ...
              <form className="mt-8 space-y-5" onSubmit={handleSubmit}>
                ...
                <div className="grid gap-5 sm:grid-cols-2">
                  <div>
                    <label className="mb-2 block text-sm font-semibold uppercase tracking-[0.12em] text-[#214c34]">
                      Phone Number <span className="text-[#8b8f8c] normal-case tracking-normal font-normal">(optional)</span>
                    </label>
                    <input
                      type="text"
